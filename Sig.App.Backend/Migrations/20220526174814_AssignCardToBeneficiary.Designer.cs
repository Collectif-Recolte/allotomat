...
namespace Sig.App.Backend.Migrations
{
    ...
    [Migration("20220526174814_AssignCardToBeneficiary")]
    partial class AssignCardToBeneficiary
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sig.App.Backend.DbModel.Entities.Cards.CardBeneficiary", b =>
                {
                    ...
                    b.HasKey("CardId", "BeneficiaryId");

                    b.HasIndex("BeneficiaryId")
                        .IsUnique();

                    b.ToTable("CardBeneficiaries");
                });
            ...
            modelBuilder.Entity("Sig.App.Backend.DbModel.Entities.Subscriptions.SubscriptionBeneficiary", b =>
                {
                    ...
                    b.HasKey("SubscriptionId", "BeneficiaryId");
            ...
            modelBuilder.Entity("Sig.App.Backend.DbModel.Entities.Cards.CardBeneficiary", b =>
                {
                    b.HasOne("Sig.App.Backend.DbModel.Entities.Beneficiaries.Beneficiary", "Beneficiary")
                        .WithOne("Card")
                        .HasForeignKey("Sig.App.Backend.DbModel.Entities.Cards.CardBeneficiary", "BeneficiaryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Sig.App.Backend.DbModel.Entities.Subscriptions.SubscriptionBeneficiary", b =>
                {
                    ...
                    b.HasOne("Sig.App.Backend.DbModel.Entities.Subscriptions.SubscriptionType", "Type")
                        .WithMany("Beneficiaries")
