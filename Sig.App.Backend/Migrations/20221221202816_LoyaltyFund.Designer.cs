...
namespace Sig.App.Backend.Migrations
{
    ...
    [Migration("20221221202816_LoyaltyFund")]
    partial class LoyaltyFund
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sig.App.Backend.DbModel.Entities.Transactions.AddingFundTransaction", b =>
                {
                    ...
                    b.Property<decimal>("AvailableFund")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("AddingFundTransaction_AvailableFund");
            ...
            modelBuilder.Entity("Sig.App.Backend.DbModel.Entities.Transactions.PaymentTransaction", b =>
                {
                    ...
                    b.Property<long?>("LoyaltyAddingFundTransactionId")
                        .HasColumnType("bigint");

                    b.Property<long>("MarketId")
                        .HasColumnType("bigint");

                    b.HasIndex("LoyaltyAddingFundTransactionId");
            ...
            modelBuilder.Entity("Sig.App.Backend.DbModel.Entities.Transactions.PaymentTransaction", b =>
                {
                    b.HasOne("Sig.App.Backend.DbModel.Entities.Transactions.LoyaltyAddingFundTransaction", null)
                        .WithMany("Transactions")
                        .HasForeignKey("LoyaltyAddingFundTransactionId");
