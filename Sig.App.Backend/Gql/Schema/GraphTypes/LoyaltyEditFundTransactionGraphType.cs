...
{
    public class LoyaltyEditFundTransactionGraphType : IAddingFundTransactionGraphType
    {
        private readonly LoyaltyEditFundTransaction transaction;
        ...
        // LoyaltyEditFundTransaction is always Actived
        public FundTransactionStatus Status => FundTransactionStatus.Actived;

        public LoyaltyEditFundTransactionGraphType(LoyaltyEditFundTransaction transaction)
        {
        ...
        // LoyaltyEditFundTransaction does not have ExpirationDate
