        ...
        public void AddAmountToTransactionLog(PaymentTransaction paymentTransaction, Card card, Market market, Subscription subscription, ProductGroup productGroup, decimal amount)
        {
            ...
            if (transactionLog == null)
            {
                transactionLog = new TransactionLog()
                {
                    ...
                    BeneficiaryId = card.Beneficiary != null ? card.Beneficiary.Id : null,
                    BeneficiaryID1 = card.Beneficiary != null ? card.Beneficiary.ID1 : "",
                    BeneficiaryID2 = card.Beneficiary != null ? card.Beneficiary.ID2 : "",
                    BeneficiaryFirstname = card.Beneficiary != null ? card.Beneficiary.Firstname : "",
                    BeneficiaryLastname = card.Beneficiary != null ? card.Beneficiary.Lastname : "",
                    BeneficiaryEmail = card.Beneficiary != null ? card.Beneficiary.Email : "",
                    BeneficiaryPhone = card.Beneficiary != null ? card.Beneficiary.Phone : "",
                    BeneficiaryIsOffPlatform = card.Beneficiary != null ? card.Beneficiary is OffPlatformBeneficiary : false,
                    BeneficiaryTypeId = card.Beneficiary != null ? card.Beneficiary.BeneficiaryTypeId : null,
                    OrganizationId = card.Beneficiary != null ? card.Beneficiary.OrganizationId : null,
                    OrganizationName = card.Beneficiary != null ? card.Beneficiary.Organization.Name : "",
