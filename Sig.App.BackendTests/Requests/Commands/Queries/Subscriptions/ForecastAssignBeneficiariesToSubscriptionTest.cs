...
namespace Sig.App.BackendTests.Requests.Commands.Queries.Subscriptions
{
    public class ForecastAssignBeneficiariesToSubscriptionTest : TestBase
    {
        private readonly ForecastAssignBeneficiariesToSubscription handler;
        ...
        public ForecastAssignBeneficiariesToSubscriptionTest()
        {
            ...
            handler = new ForecastAssignBeneficiariesToSubscription(Clock, DbContext);

            Clock.Reset(Instant.FromUtc(today.Year, today.Month, 4, 0, 0));
        }

        [Fact]
        public async Task ForecastAssignSubscriptionToAllBeneficiaries()
        {
            var input = new ForecastAssignBeneficiariesToSubscription.Input()
            {
            ...
            result.BeneficiariesWhoGetSubscriptions.Should().Be(8);
            result.TotalBeneficiaries.Should().Be(8);
            result.AvailableBudgetAfter.Should().Be(60);
        }

        [Fact]
        public async Task ForecastAssignSubscriptionToBeneficiaries9()
        {
            ...
            result.BeneficiariesWhoGetSubscriptions.Should().Be(1);
            result.TotalBeneficiaries.Should().Be(1);
            result.AvailableBudgetAfter.Should().Be(590);
        }

        [Fact]
        public async Task ForcastAssignSubscriptionToZeroBeneficiaries()
        {
            var input = new ForecastAssignBeneficiariesToSubscription.Input()
            {
                OrganizationId = organization.GetIdentifier(),
            ...
            result.BeneficiariesWhoGetSubscriptions.Should().Be(0);
            result.TotalBeneficiaries.Should().Be(0);
            result.AvailableBudgetAfter.Should().Be(700);
        }
        ...
        public async Task AssignSubscriptionToBeneficiariesOfType2()
        {
            ...
            result.BeneficiariesWhoGetSubscriptions.Should().Be(4);
            result.TotalBeneficiaries.Should().Be(4);
            result.AvailableBudgetAfter.Should().Be(300);
        }
        ...
        public async Task AssignSubscriptionWithMaximumAmount()
        {
            ...
            result.BeneficiariesWhoGetSubscriptions.Should().Be(2);
            result.TotalBeneficiaries.Should().Be(8);
            result.AvailableBudgetAfter.Should().Be(540);
        }
        ...
        public async Task ThrowsIfOrganizationNotFound()
        {
            ...
            await F(() => handler.Handle(input, CancellationToken.None))
                .Should().ThrowAsync<ForecastAssignBeneficiariesToSubscription.OrganizationNotFoundException>();
        }
        ...
        public async Task ThrowsIfSubsriptionNotFound()
        {
            ...
            await F(() => handler.Handle(input, CancellationToken.None))
                .Should().ThrowAsync<ForecastAssignBeneficiariesToSubscription.SubscriptionNotFoundException>();
        }
        ...
        public async Task ThrowsIfSubscriptionAlreadyExpiredException()
        {
            ...
            await F(() => handler.Handle(input, CancellationToken.None))
                .Should().ThrowAsync<ForecastAssignBeneficiariesToSubscription.SubscriptionAlreadyExpiredException>();
        }
        ...
        public async Task ThrowsIfMissingBudgetAllowance()
        {
            ...
            await F(() => handler.Handle(input, CancellationToken.None))
                .Should().ThrowAsync<ForecastAssignBeneficiariesToSubscription.MissingBudgetAllowanceException>();
        }
    }
}
