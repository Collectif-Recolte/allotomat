<i18n>
  {
    "en": {
      ...
      "resend-complete": "A message to finish creating the account was sent to {email}.",
      ...
      "associated-program-market-group-merchant": "Program, merchant group, and/or merchant associated"
    },
    "fr": {
      "admin-pca": "Administrateur",
      "edit-profile": "Modifier le profil du compte",
      "last-login-date": "Dernière connexion",
      "merchant": "Commerce",
      "merchant-group-manager": "Gestionnaire de groupe de commerces",
      ...
      "role": "Rôle",
      "status": "Statut",
      "user-confirmed": "Compte confirmé",
      "user-not-confirmed": "Compte non confirmé",
      ...
      "reactivate-user": "Réactiver le compte",
      "disable-user": "Désactiver le compte",
      "associated-program-market-group-merchant": "Programme, groupe, et/ou commerce associé"
    }
  }
  </i18n>
