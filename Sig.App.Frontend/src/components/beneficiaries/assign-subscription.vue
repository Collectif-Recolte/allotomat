<i18n>
{
  "en": {
    ...
    "dont-have-budget-allowance": "→ <b>The subscription does not have a budget envelope for this participant group</b>",
    "dont-have-beneficiary-type": "→ <b>The subscription does not have a payment amount for this participant category</b>",
    ...
    "budget-allowance-not-enought": "→ <b>The budget envelope is not sufficient to cover the remaining payments</b>",
    ...
    "dont-have-budget-allowance": "→ <b>L'abonnement n'a pas d'enveloppe budgétaire pour ce groupe de participant·e·s</b>",
    "dont-have-beneficiary-type": "→ <b>L'abonnement n'a pas de montant de paiement pour cette catégorie de participant·e</b>",
