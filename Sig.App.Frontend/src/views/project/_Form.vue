<i18n>
{
	"en": {
		"cancel": "Cancel",
		"project-name": "Name",
		"project-name-placeholder": "Ex. FMNCP",
    "project-url": "Website",
    "project-url-description": "Ex. https://bcfarmersmarket.org/",
    "project-allow-organizations-assign-cards": "Allow participant group managers to assign cards",
    "project-beneficiaries-are-anonymous": "Anonymous participants",
    "project-administration-subscriptions-off-platform": "The administration of participants is done off-platform",
    "reconciliation-report-date": "Reconciliation report default time period",
    ...
    "project-allow-organizations-assign-cards": "Permettre aux gestionnaires des groupes de participant·e·s d’assigner des cartes",
    ...
    "reconciliation-report-date": "Période par défaut du rapport de réconciliation",
