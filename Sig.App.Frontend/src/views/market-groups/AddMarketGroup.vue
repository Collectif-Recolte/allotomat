<i18n>
{
	...
	"fr": {
		...
		"add-market-group-success-notification": "L’ajout du groupe de commerces {marketGroupName} a été un succès. Les gestionnaires vont recevoir un courriel pour compléter la création de leurs comptes dans les prochaines minutes.",
