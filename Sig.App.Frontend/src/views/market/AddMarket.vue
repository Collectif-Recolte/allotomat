<i18n>
{
	"en": {
		"add-market": "Add",
		"add-market-success-notification": "Adding merchant {marketName} was successful. Managers will receive an email to finish creating their account in the next few minutes.",
	...
	"fr": {
		"add-market": "Ajouter",
		"add-market-success-notification": "L’ajout du commerce {marketName} a été un succès. Les gestionnaires vont recevoir un courriel pour compléter la création de leur compte dans les prochaines minutes.",
