<i18n>
{
	"en": {
		...
		"organization-manager-without-organization-warning": "No organization is associated with your account. If you believe there has been an error, contact the Tomat team.",
		"password": "Password",
	...
	"fr": {
		...
		"organization-manager-without-organization-warning": "Aucune organisation n'est associée à votre compte. Si vous croyez qu'il y a eu une erreur, communiquez avec l'équipe de Tomat.",
