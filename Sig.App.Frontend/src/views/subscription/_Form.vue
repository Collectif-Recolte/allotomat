<i18n>
{
    ...
    "add-subscription-type": "Add a participant category",
		"empty-product-group-subscription-types-list-error": "At least one product group is required",
    ...
    "subscription-type-category-must-be-unique": "A participant category can only be added once per product group",
    "subscription-product-group-must-be-unique": "A product group can only be added once per participant category",
    ...
    "subscription-trigger-fund-expiration": "Fund expiration mode",
    ...
    "subscription-days-until-funds-expire-after-first-use": "Number of days until expiry",
    ...
    "product-group-delete": "Supprimer le groupe de produits",
		"cancel": "Annuler",
    "add-subscription-type": "Ajouter une catégorie de participant·e",
		"empty-product-group-subscription-types-list-error": "Au moins un groupe de produits est requis",
    ...
    "subscription-name-desc": "<p>Ces paramètres déterminent les dates auxquelles les fonds seront automatiquement ajoutés aux cartes. (Dans les étapes suivantes, vous définirez les dates d'expiration et les montants que les cartes recevront.) Notez que les abonnements <b>ne peuvent pas être modifiés</b> une fois qu'ils ont été attribués aux participant·e·s !</p>",
    ...
    "subscription-type-category-must-be-unique": "Une catégorie de participant·e·s ne peut être ajoutée qu'une seule fois par groupe de produits",
    "subscription-product-group-must-be-unique": "Un groupe de produits ne peut être ajouté qu'une seule fois par catégorie de participant·e·s",
    ...
    "subscription-days-until-funds-expire-after-first-use": "Échéance des fonds après l'usage initial (jours)",
