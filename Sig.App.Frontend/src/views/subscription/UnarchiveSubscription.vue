<i18n>
{
	...
	"fr": {
		...
		"description": "Avertissement ! Si vous continuez, l'abonnement sera désarchivé et il pourra être assigné à un·e participant·e. Par contre, les fonds des cartes vont rester inchangés. (Cette action peut être annulée plus tard.)",
