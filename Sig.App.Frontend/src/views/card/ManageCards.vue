<i18n>
{
	"en": {
		...
		"title": "Cards",
    "empty-card-list": "The program has not yet generated any cards.",
    ...
    "card-is-enabled": "Card is activated",
	...
	"fr": {
		...
		"title": "Cartes",
    "empty-card-list": "Le programme n'a encore généré aucune carte.",
...
<template>
  <Loading :loading="loadingProjects" is-full-height>
    <RouterView v-slot="{ Component }">
      ...
      <div v-if="cards && cardsPagination" class="px-section md:px-8 py-5">
        <UiTableHeader>
          <template #right>
            <UiFilter
              v-model="searchInput"
