...
import { URL_CARDS_ASSIGNATION, URL_CARD_ERROR, URL_CARD_ASSIGN, URL_BENEFICIARY_ADMIN } from "@/lib/consts/urls";
...
function returnRoute() {
  if (route.name === URL_CARD_ASSIGN) return { name: URL_CARDS_ASSIGNATION };
